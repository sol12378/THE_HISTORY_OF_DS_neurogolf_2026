...
EXP_DIR = ROOT / "experiments" / "exp008_extra_public_sources_strict"
...
SOURCES = [
    ...
    {
        "label": "jvlegend_conservative_v136_plus13",
        "kind": "dataset",
        "ref": "jvlegend/neurogolf-resolve-conservative-v136-plus13",
        "priority": 33,
    },
    {
        "label": "franksunp_v24_blend_submission",
        "kind": "dataset",
        "ref": "franksunp/neurogolf-v24-blend-submission",
        "priority": 34,
    },
    {
        "label": "franksunp_blended_v24",
        "kind": "dataset",
        "ref": "franksunp/neurogolf-blended-v24",
        "priority": 35,
    },
    {
        "label": "franksunp_v18_multi_source",
        "kind": "dataset",
        "ref": "franksunp/neurogolf-2026-v18-multi-source-artifact",
        "priority": 36,
    },
    {
        "label": "thisray_4808_metric_update",
        "kind": "dataset",
        "ref": "thisray/neurogolf-4808-21-post-apr-28-metric-update",
        "priority": 37,
    },
    {
        "label": "thisray_4743_task_table",
        "kind": "dataset",
        "ref": "thisray/neurogolf-4743-93-submission-task-table",
        "priority": 38,
    },
    {
        "label": "gfarew_solution_pack",
        "kind": "dataset",
        "ref": "gfarew/neurogolf-solution-pack",
        "priority": 39,
    },
    {
        "label": "needless090_onnx_v31",
        "kind": "dataset",
        "ref": "needless090/neurogolf-onnx-v31",
        "priority": 40,
    },
    {
        "label": "tonylica_google_public",
        "kind": "dataset",
        "ref": "tonylica/google-neurogolf-2026-public",
        "priority": 41,
    },
    {
        "label": "konbu17_blended_341",
        "kind": "dataset",
        "ref": "konbu17/neurogolf-2026-blended-341",
        "priority": 42,
    },
]
...
def main() -> None:
    ...
    result = {
        "exp_id": "exp008_extra_public_sources_strict",
        ...
        "next_actions": [
            "追加sourceでも6500未満なら、task366などの専用template rewriteに戻る。",
            "採用改善があればexp005の未使用initializer削除を再適用する。",
            "Kaggle submit前にfull arc-gen validationを採用済みtaskへ拡張する。",
        ],
    }
