...
EXP_ID = "exp233_task300_channel_gather_mask4x3_cost_probe"
...
def build_candidate() -> bytes:
    initializers = [
        ...
        numpy_helper.from_array(np.asarray([1, 1, 30, 30], dtype=np.int64), "chan_tile_repeats"),
    ...
    nodes = [
        ...
        helper.make_node("Reshape", ["sel_color", "shape1111"], ["sel_color_4d"]),
        helper.make_node("Tile", ["sel_color_4d", "chan_tile_repeats"], ["channel_idx"]),
        helper.make_node("GatherElements", ["input", "channel_idx"], ["selected_spatial"], axis=1),
...
def main() -> None:
    ...
    result = {
        ...
        "decision": "improvedならbundle/submission候補。no_cost_gainならtask300 max-color laneは一旦保留。",
