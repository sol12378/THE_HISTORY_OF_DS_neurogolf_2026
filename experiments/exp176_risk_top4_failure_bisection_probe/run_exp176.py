...
EXP_DIR = ROOT / "experiments" / "exp176_risk_top4_failure_bisection_probe"
...
TARGET_POINTS = {
    202: 13.258187509088495,
    382: 13.416112936092428,
    205: 13.370955104619776,
    383: 13.246161795004017,
}
...
def make_zero_stub() -> bytes:
    ...
    graph = helper.make_graph(
        ...
        "exp176_zero_fail_stub",
        [helper.make_tensor_value_info("input", TensorProto.FLOAT, [1, 10, 30, 30])],
        [helper.make_tensor_value_info("output", TensorProto.FLOAT, [1, 10, 30, 30])],
        [zero],
    )
    model = helper.make_model(graph, producer_name="exp176_zero_fail_stub", ir_version=10, opset_imports=[helper.make_opsetid("", 10)])
...
def main() -> None:
    ...
    result: dict[str, Any] = {
        "exp_id": "exp176_risk_top4_failure_bisection_probe",
        "date": "2026-06-10",
        "status": "probe_zip_ready",
        "purpose": "Prepare high-risk-inventory fail-stub probe for task202/382/205/383 after subset-derived suspects are exhausted.",
