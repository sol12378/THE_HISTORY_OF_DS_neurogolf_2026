...
EXP_DIR = ROOT / "experiments" / "exp155_next4i_failure_bisection_probe"
BASE_EXP = ROOT / "experiments" / "exp127_focused_surgery_seventh_pass_limited"
BASE_ZIP = BASE_EXP / "submission.zip"
TARGETS = [63, 22, 37, 20]
TARGET_POINTS = {
    63: 14.666940264012474,
    22: 14.542024067963268,
    37: 13.937652078450405,
    20: 13.801114272168789,
}
...
def make_zero_stub() -> bytes:
    ...
    graph = helper.make_graph(
        ...
        "exp155_zero_fail_stub",
        [helper.make_tensor_value_info("input", TensorProto.FLOAT, [1, 10, 30, 30])],
        [helper.make_tensor_value_info("output", TensorProto.FLOAT, [1, 10, 30, 30])],
        [zero],
    )
    model = helper.make_model(graph, producer_name="exp155_zero_fail_stub", ir_version=10, opset_imports=[helper.make_opsetid("", 10)])
...
def main() -> None:
    ...
    result: dict[str, Any] = {
        "exp_id": "exp155_next4i_failure_bisection_probe",
        "date": "2026-06-10",
        "status": "probe_zip_ready",
        "purpose": "Continue public-zero bisection after exp154: intentionally fail next remaining frequent subset tasks 063/022/037/020.",
