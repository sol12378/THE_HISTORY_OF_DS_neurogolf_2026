...
EXP_DIR = ROOT / "experiments" / "exp187_risk_next4e_candidate_validation_audit"
...
def audit_task(utils: Any, task_id: int) -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    for row in source_rows:
        ...
        memory, params, score_reason = score_model(utils, raw, task_id, f"exp187_task{task_id:03d}_{row['exp']}", EXP_DIR)
...
def main() -> None:
    ...
    out_csv = EXP_DIR / "risk_next4e_candidate_audit.csv"
    if all_rows:
    ...
    result = {
        "exp_id": "exp187_risk_next4e_candidate_validation_audit",
        "date": "2026-06-10",
        ...
        "decision": "Use this audit if exp184 identifies a public-zero target among task284/300/379/340.",
