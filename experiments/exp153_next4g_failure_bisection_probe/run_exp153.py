...
EXP_DIR = ROOT / "experiments" / "exp153_next4g_failure_bisection_probe"
BASE_EXP = ROOT / "experiments" / "exp127_focused_surgery_seventh_pass_limited"
BASE_ZIP = BASE_EXP / "submission.zip"
TARGETS = [51, 49, 46, 11]
TARGET_POINTS = {
    51: 13.866448009633856,
    49: 14.674878758194124,
    46: 14.58291068075113,
    11: 13.898854540195707,
}
...
def make_zero_stub() -> bytes:
    ...
    graph = helper.make_graph(
        ...
        "exp153_zero_fail_stub",
        [helper.make_tensor_value_info("input", TensorProto.FLOAT, [1, 10, 30, 30])],
        [helper.make_tensor_value_info("output", TensorProto.FLOAT, [1, 10, 30, 30])],
        [zero],
    )
    model = helper.make_model(graph, producer_name="exp153_zero_fail_stub", ir_version=10, opset_imports=[helper.make_opsetid("", 10)])
...
def main() -> None:
    ...
    result: dict[str, Any] = {
        "exp_id": "exp153_next4g_failure_bisection_probe",
        "date": "2026-06-10",
        "status": "probe_zip_ready",
        "purpose": "Continue public-zero bisection after exp152: intentionally fail next remaining frequent subset tasks 051/049/046/011.",
