...
runner.EXP_ID = "exp127_focused_surgery_seventh_pass_limited"
...
runner.PREV_EXPS = [
    ...
    ROOT / "experiments" / "exp125_focused_surgery_fifth_pass_limited",
    ROOT / "experiments" / "exp126_focused_surgery_sixth_pass_limited",
]
runner.BASE_ZIP_EXP = runner.PREV_EXPS[-1]
runner.OUTPUT_ZIP = runner.EXP_DIR / "submission.zip"
runner.CURRENT_LOCAL_ESTIMATE = 6282.96238134373
