...
EXP_DIR = ROOT / "experiments" / "exp148_next4d_failure_bisection_probe"
...
TARGET_POINTS = {
    366: 11.362564029982357,
    77: 13.032857358715912,
    64: 13.354705067178468,
    84: 15.030297975010043,
}
...
def make_zero_stub() -> bytes:
    ...
    graph = helper.make_graph(
        ...
        "exp148_zero_fail_stub",
        [helper.make_tensor_value_info("input", TensorProto.FLOAT, [1, 10, 30, 30])],
        [helper.make_tensor_value_info("output", TensorProto.FLOAT, [1, 10, 30, 30])],
        [zero],
    )
    model = helper.make_model(graph, producer_name="exp148_zero_fail_stub", ir_version=10, opset_imports=[helper.make_opsetid("", 10)])
...
def main() -> None:
    ...
    result: dict[str, Any] = {
        "exp_id": "exp148_next4d_failure_bisection_probe",
        "date": "2026-06-10",
        "status": "probe_zip_ready",
        "purpose": "Continue public-zero bisection: intentionally fail next consensus tasks 366/077/064/084.",
