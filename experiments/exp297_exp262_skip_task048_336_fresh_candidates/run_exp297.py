...
EXP_ID = "exp297_exp262_skip_task048_336_fresh_candidates"
EXP_DIR = ROOT / "experiments" / EXP_ID
BASE_BUNDLE = ROOT / "experiments" / "exp265_exp264_bypass_bundle_submit_probe" / "submission.zip"
SOURCE_MANIFEST = EXP_DIR / "selected_manifest_fresh.csv"
EXPECTED_BASE_LB = 6008.90
...
def main() -> None:
    ...
    result = {
        ...
        "zip_sanity": sanity,
        "submission_decision": "submit" if selected_rows and not failures and EXPECTED_BASE_LB + delta > EXPECTED_BASE_LB else "review_before_submit",
        "leakage_risk": "low-medium: full-arc gated graph surgery replay on current best bundle.",
