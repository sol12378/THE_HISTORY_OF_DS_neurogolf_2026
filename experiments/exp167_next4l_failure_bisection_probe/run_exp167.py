...
EXP_DIR = ROOT / "experiments" / "exp167_next4l_failure_bisection_probe"
...
TARGETS = [48, 35, 12, 17]
TARGET_POINTS = {
    48: 16.367872270491663,
    35: 15.36028269986934,
    12: 15.555457449352874,
    17: 14.540073127737525,
}
...
def make_zero_stub() -> bytes:
    ...
    graph = helper.make_graph(
        ...
        "exp167_zero_fail_stub",
        [helper.make_tensor_value_info("input", TensorProto.FLOAT, [1, 10, 30, 30])],
        [helper.make_tensor_value_info("output", TensorProto.FLOAT, [1, 10, 30, 30])],
        [zero],
    )
    model = helper.make_model(graph, producer_name="exp167_zero_fail_stub", ir_version=10, opset_imports=[helper.make_opsetid("", 10)])
...
def main() -> None:
    ...
    result: dict[str, Any] = {
        "exp_id": "exp167_next4l_failure_bisection_probe",
        "date": "2026-06-10",
        "status": "probe_zip_ready",
        "purpose": "Probe next remaining subset-frequency public-zero suspects 048/035/012/017 after exp166 current best.",
