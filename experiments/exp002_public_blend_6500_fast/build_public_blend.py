...
EXP_DIR = ROOT / "experiments" / "exp002_public_blend_6500_fast"
...
def main() -> None:
    ...
    result = {
        "exp_id": "exp002_public_blend_6500_fast",
        ...
        "next_actions": [
            "6500未満なら、403 kernel outputの代替取得または追加dataset sourceを探す。",
            "source別の不採用理由とtop expensive tasksを見て、cost低下rewriteまたは自前templateを追加する。",
