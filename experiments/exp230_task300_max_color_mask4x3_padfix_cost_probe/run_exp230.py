...
EXP_ID = "exp230_task300_max_color_mask4x3_padfix_cost_probe"
...
def main() -> None:
    ...
    candidate = Candidate(
        TASK_ID,
        "max_color_bbox_mask4x3_padfix",
        base.route,
        build_candidate(),
        "generated",
        "select max nonzero color count, gather 4x3 bbox mask, channel0 only inside crop",
    )
