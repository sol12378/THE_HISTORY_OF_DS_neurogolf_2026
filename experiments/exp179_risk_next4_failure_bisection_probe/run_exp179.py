...
EXP_DIR = ROOT / "experiments" / "exp179_risk_next4_failure_bisection_probe"
...
TARGET_POINTS = {
    251: 13.481291290274044,
    109: 13.539652865248629,
    239: 13.54388830238479,
    358: 13.356739495302836,
}
...
def make_zero_stub() -> bytes:
    ...
    graph = helper.make_graph(
        ...
        "exp179_zero_fail_stub",
        [helper.make_tensor_value_info("input", TensorProto.FLOAT, [1, 10, 30, 30])],
        [helper.make_tensor_value_info("output", TensorProto.FLOAT, [1, 10, 30, 30])],
        [zero],
    )
    model = helper.make_model(graph, producer_name="exp179_zero_fail_stub", ir_version=10, opset_imports=[helper.make_opsetid("", 10)])
...
def main() -> None:
    ...
    result: dict[str, Any] = {
        "exp_id": "exp179_risk_next4_failure_bisection_probe",
        "date": "2026-06-10",
        "status": "probe_zip_ready",
        "purpose": "Prepare next high-risk-inventory fail-stub probe for task251/109/239/358 while exp176 scores.",
        ...
        "submission_decision": "hold_until_exp176_result",
