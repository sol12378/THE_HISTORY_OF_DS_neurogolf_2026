...
EXP_DIR = ROOT / "experiments" / "exp140_next4_failure_bisection_probe"
...
def make_zero_stub() -> bytes:
    ...
    model = helper.make_model(
        graph,
        producer_name="exp140_zero_fail_stub",
        ir_version=10,
...
def main() -> None:
    ...
    target_points = {
        24: 15.88617052840466,
        18: 13.35098890724301,
        4: 14.084547965521434,
        19: 13.69353305881371,
    }
    expected_drop_if_all_alive = sum(target_points.values())
    result: dict[str, Any] = {
        "exp_id": "exp140_next4_failure_bisection_probe",
        "date": "2026-06-10",
        "status": "probe_zip_ready",
        "purpose": "A-3 bisection probe after exp139 excluded top4: intentionally fail next consensus tasks 024/018/004/019.",
